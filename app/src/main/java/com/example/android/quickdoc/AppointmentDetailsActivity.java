...
public class AppointmentDetailsActivity extends AppCompatActivity {
    ...
    @BindView(R.id.tv_app_time) TextView textViewTime;
    ...
    private void startFirebaseListener(final UserAppointment userAppointment) {
        ...
        databaseReference = firebaseDatabase.getReference().child(FIREBASE_CHILD_DOCTORS).child(userAppointment.getSpecialty());
        ...
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (doctorDetailsList != null) {
                    doctorDetails = new DoctorDetailsToUser(doctorDetailsList.get(userAppointment.getDoctorId()));
                }
    ...
    private void setTextViews(DoctorDetailsToUser doctorDetailsToUser, UserAppointment userAppointment) {
        ...
        textViewDate.setText(userAppointment.getDate());
        textViewTime.setText(userAppointment.getTime());
    ...
    public void setOnClickListeners(final DoctorDetailsToUser doctorDetailsToUser, final String specialtyKey){
        ...
        buttonCancelAppointment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //TODO - chamar um confirmation dialog
