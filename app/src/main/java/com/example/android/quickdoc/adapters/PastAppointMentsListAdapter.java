...
public class PastAppointMentsListAdapter extends RecyclerView.Adapter<PastAppointMentsListAdapter.NextAppViewHolder>{
    ...
    public PastAppointMentsListAdapter(ArrayList<UserAppointment> userAppointmentsList, ArrayList<String> childKeys, Context context) {
    ...
    @NonNull
    @Override
    public PastAppointMentsListAdapter.NextAppViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final PastAppointMentsListAdapter.NextAppViewHolder holder, final int position) {
